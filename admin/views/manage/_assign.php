...
?>
                                ...
                                <div class="span12 field-box" style="margin: 20px 10px 10px 30px;">
                                <?php echo Html::label('角色', null). Html::checkboxList('children', !empty($children['roles']) ?$children['roles'] : null, $roles); ?>
                                </div>
                                <div class="span12 field-box" style="margin: 20px 10px 10px 30px;">
                                <?php echo Html::label('权限', null). Html::checkboxList('children', !empty($children['permissions']) ?$children['permissions'] : null, $permissions); ?>
                                </div>
