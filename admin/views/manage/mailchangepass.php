    ...
    <div class="span4 box">
        <div class="content-wrap">
            ...
            <div class="form-group field-admin-adminuser">
                ...
                <?php echo $form->field($admin,'admin_user')->hiddenInput(['class'=>'span12','placeholder'=>'管理员账号'])  ?>
                <div class="form-group field-admin-adminpass">
                    <p class="help-block help-block-error"></p>
                    <?php echo $form->field($admin,'admin_pass')->passwordInput(['class'=>'span12','placeholder'=>'新密码'])  ?>
                </div>
                <div class="form-group field-admin-adminpass">
                    <p class="help-block help-block-error"></p>
                    <?php echo $form->field($admin,'repass')->passwordInput(['class'=>'span12','placeholder'=>'确认密码'])  ?>
